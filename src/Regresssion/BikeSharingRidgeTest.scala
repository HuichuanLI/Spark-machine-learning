...
object BikeSharingRidgeTest {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // TODO: RMSE = 145.1989479317291
    // val lrModel = RidgeRegressionWithSGD.train(trainRDD, 10)

    // TODO: 设置迭代次数为100   RMSE = 117.55165843169313
    // val lrModel = RidgeRegressionWithSGD.train(trainRDD, 100)

    // TODO: 设置正则化参数位0.001    RMSE = 115.09744522313535
    // val lrModel = RidgeRegressionWithSGD.train(trainRDD, 100, 1.0, 0.001, 1.0)

    // TODO: 设置正则化参数位0.1   RMSE = 137.17219114535564
    val lrModel = RidgeRegressionWithSGD.train(trainRDD, 100, 1.0, 0.1, 1.0)
